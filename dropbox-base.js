...
Base.prototype.listNames = function(data) {
  ...
  var docNames = [];
    data.forEach(function(item, index) {
      item = {"doc_id": item, export_format: "markdown"};
...
Base.prototype.makeOptions = function(method, route, body) {
  ...
  if(route == routes.downloadDoc) {
  	...
  	that.options.headers["Dropbox-API-Arg"] = http_header_safe_json({"doc_id": body.doc_id, "export_format":{".tag": body.export_format}});
